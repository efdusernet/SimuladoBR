...
app.use(`${API_V1}/app`, require('./routes/app'));
...
app.use(`${API_V1}/admin/marketplace/access`, require('./routes/admin_marketplace_access'));
...
app.use(`${API_BASE}/app`, require('./routes/app'));
...
app.use(`${API_BASE}/admin/marketplace/access`, require('./routes/admin_marketplace_access'));
