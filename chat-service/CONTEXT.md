...
Existe um `src/services/llmClient.js` que encapsula a integração com LLM (atualmente Gemini via `GEMINI_*`), mas o chat inicial não depende de LLM para funcionar.
