...
| POST | `/api/ai/question-audit` | Admin | Body: `{ question, web? }` | `{ success, audit, sources, meta }` | Audita coerência/correção de questão usando contexto retornado pelos endpoints web e gera JSON via Gemini. |
